// service/BuildingFloorConfigService.java
...
public class BuildingFloorConfigService {
        ...
        public BuildingFloorConfigResponse create(BuildingFloorConfigRequest request) {
                ...
                return BuildingFloorConfigResponse.from(repository.save(entity));
        }

        public BuildingFloorConfigResponse update(Long id, BuildingFloorConfigRequest request) {
